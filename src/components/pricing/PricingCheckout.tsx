    ...
    <div className="af-glass-card af-plan-card">
      ...
      <div className="af-plan-split">
        ...
        <div className="af-plan-left">
          ...
          <button type="button" onClick={onChoose} style={{ alignSelf: "flex-start", display: "inline-flex", alignItems: "center", gap: 8, height: 44, padding: "0 20px", borderRadius: 12, border: "none", cursor: "pointer", font: "600 14px/1 var(--font-sans)", background: "var(--indigo-600)", color: "#fff", boxShadow: "0 6px 16px rgba(39,85,223,.28)" }}>
            Buy now
