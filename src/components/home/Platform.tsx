    ...
    <div style={{ background: "var(--card)", padding: "56px 24px" }}>
      <Container>
        ...
        <div style={{ display: "flex", justifyContent: "center", marginTop: 28 }}>
          <Link className="af-btn-ghost" href="/our-service" style={{ display: "inline-flex", alignItems: "center", gap: 8, height: 44, padding: "0 22px", borderRadius: "var(--radius-control)", border: "1.5px solid var(--indigo-600)", color: "var(--indigo-600)", font: "600 14px/1 var(--font-sans)", boxSizing: "border-box" }}>
