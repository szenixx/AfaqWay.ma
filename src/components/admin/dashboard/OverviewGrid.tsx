    ...
    <div className="dash-grid ov-grid">
      ...
      <div className="span4">
        <div className="dash-stats-row">
          <StatCard label="Total students" value={d.totalStudents} loading={d.loading} accent={ACCENTS[0]} icon={<Users size={16} />} delta={8} />
          <StatCard label="Active students" value={d.activeStudents} loading={d.loading} accent={ACCENTS[1]} icon={<CircleCheckBig size={16} />} delta={5} />
          <StatCard label="New today" value={d.newToday} loading={d.loading} accent={ACCENTS[2]} icon={<UserPlus size={16} />} />
          <StatCard label="Countries" value={d.countryDist.length} loading={d.loading} accent={ACCENTS[3]} icon={<Globe size={16} />} />
          <StatCard label="Applications" value={d.journey[3]?.value ?? 0} loading={d.loading} accent={ACCENTS[4]} icon={<FileText size={16} />} delta={12} />
          <StatCard label="Arrived" value={d.journey[5]?.value ?? 0} loading={d.loading} accent={ACCENTS[5]} icon={<Plane size={16} />} />
        </div>
      </div>
