              ...
              return (
                <div key={step} style={{ display: "flex", gap: 16 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                    <span style={{ width: 40, height: 40, borderRadius: 999, flex: "none", display: "flex", alignItems: "center", justifyContent: "center", background: active || done ? "var(--indigo-600)" : "rgba(255,255,255,.75)", color: active || done ? "#fff" : "var(--ink-faint)", border: upcoming ? "1px solid var(--line)" : "none", font: "600 15px/1 var(--font-sans)", boxShadow: active ? "0 6px 16px rgba(39,85,223,.35)" : "none" }}>
