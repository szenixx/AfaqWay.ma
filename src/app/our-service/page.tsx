  ...
  return (
    <main>
          ...
          <div style={{ marginTop: 34, border: "1px solid var(--line)", borderRadius: 16, overflow: "hidden", background: "var(--card)", boxShadow: "var(--shadow-card)" }}>
            ...
            {AGENCY_ROWS.map((r, i) => (
              <div key={r.label} className="af-compare-row" style={{ display: "grid", gridTemplateColumns: "1.1fr 1.4fr 1.4fr", borderBottom: i < AGENCY_ROWS.length - 1 ? "1px solid var(--line-soft)" : "none" }}>
                ...
                <div style={{ padding: "16px 18px", display: "flex", gap: 9, font: "500 13px/19px var(--font-sans)", color: "var(--ink)", background: "rgba(46, 59, 199,.035)" }}>
      ...
      <section style={{ padding: "80px 24px" }}>
        <Container width={760}>
          <div style={{ background: "linear-gradient(135deg, var(--indigo-600), var(--tertiary))", borderRadius: 22, padding: "48px 32px", textAlign: "center", boxShadow: "0 20px 50px rgba(46, 59, 199,.28)" }}>
