  ...
  return (
    <main>
      ...
      <section style={{ padding: "48px 24px 80px" }}>
        <Container width={760}>
          <div style={{ background: "linear-gradient(135deg, var(--indigo-600), #4263C7)", borderRadius: 22, padding: "44px 32px", textAlign: "center", boxShadow: "0 20px 50px rgba(39,85,223,.28)" }}>
